...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Flood.py"
 
        #Name of program
        self.project_name = "Flood"
        ...
        #Auhor of program
        self.author_name = "Moahmmed Eseifan"
        ...
        self.icon_file = 'Flood Icon.ico'
 
        #Extra files/dirs copied to game
        self.extra_datas = ['SLANT.TTF']
